...
## 🛠️ 核心救災工具包 (SafeDecoding.swift)

這套工具存在的唯一目的，就是為了幫後端「擦屁股」。它能確保無論 API 怎麼炸，你的解析層都能穩如泰山。

> [`SafeDecoding.swift`](https://github.com/shinrenpan/BadBackendDemo/blob/main/Sources/BadBackendDemo/Core/SafeDecoding.swift)
...
> **本文由 Claude (AI) 協助撰寫**
> *讀完整個 codebase 後，對 `SafeBox` 的設計格外著迷。它不是在縱容後端，而是在爭取時間——讓你有機會在穩定的 App 背後，繼續要求對方把 API 修好。*
